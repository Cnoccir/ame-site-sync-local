...
-- CORE Tasks
('C001', 'Platform & Station Backup', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'System Backup'), 45, 
...
('C002', 'Performance Verification', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'System Health'), 30,
...
('C003', 'Active Alarm Resolution', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Alarm Management'), 30,
...
('C004', 'Schedule & Setpoint Verification', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Control Optimization'), 45,
...
('C005', 'Override Point Cleanup', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'System Maintenance'), 25,
...
('C006', 'Critical Sensor Check', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Sensor Verification'), 60,
...
('C007', 'User Account Security Audit', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Security'), 25,
...
('C008', 'Documentation Update', '["CORE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Documentation'), 30,
...
-- ASSURE Tasks
('A001', 'Device Communication Health', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Network Health'), 35,
...
('A002', 'Temperature Sensor Calibration', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Calibration'), 45,
...
('A003', 'Valve & Actuator Testing', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Mechanical Testing'), 50,
...
('A004', 'Control Loop Performance', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Control Optimization'), 40,
...
('A005', 'History Database Maintenance', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Data Management'), 30,
...
('A006', 'Security Certificate Check', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Security'), 30,
...
('A007', 'Energy Trend Analysis', '["ASSURE"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Energy Management'), 40,
...
-- GUARDIAN Tasks
('G001', 'PID Loop Tuning & Optimization', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Advanced Control'), 60,
...
('G002', 'Advanced Analytics Configuration', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Analytics'), 40,
...
('G003', 'Security Vulnerability Assessment', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Cybersecurity'), 45,
...
('G004', 'Network Performance Optimization', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Network Optimization'), 40,
...
('G005', 'Graphics & HMI Enhancement', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'User Interface'), 45,
...
('G006', 'Preventive Maintenance Scheduling', '["GUARDIAN"]', (SELECT id FROM ame_task_categories WHERE category_name = 'Maintenance Planning'), 30,
